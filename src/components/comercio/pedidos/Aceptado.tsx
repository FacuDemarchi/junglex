...
// import styles from './styles/Aceptado.module.css'; // Eliminado
...
interface AceptadoProps {
  pedido: Pedido;
  onCancelar: (id: string) => void;
  onListo: (id: string) => void;
}

const Aceptado: React.FC<AceptadoProps> = ({ pedido, onCancelar, onListo }) => {
  ...
  return (
    <div className="bg-gray-100 rounded-lg shadow-md mb-2 p-3 transition-colors duration-200 text-sm hover:bg-gray-200">
      <div className="flex justify-between items-center font-semibold text-green-600 mb-1 text-base">
      ...
      <div className="flex justify-between items-center mt-1 text-sm">
        <div className="flex gap-1">
          ...
          <button
            className="bg-yellow-500 text-white rounded font-semibold text-xs px-3 py-1 cursor-pointer transition-colors duration-200 hover:bg-yellow-600"
